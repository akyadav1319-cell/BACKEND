...
POLICY_COSTS = {
  ...
  "public_transport": {
        "cost_per_unit": 1.8,  # metro/bus infra expensive
        "temperature_impact": -0.0009,
        "max_impact": -0.09,
        "label": "Public Transport Electrification",
        "description": "Metro rail, electric buses, shared mobility expansion"
    },

    "industrial_controls": {
        "cost_per_unit": 1.4,
        "temperature_impact": -0.0011,
        "max_impact": -0.11,
        "label": "Industrial Emission Controls",
        "description": "Factory retrofits, carbon capture, cleaner manufacturing"
    },

    "green_buildings": {
        "cost_per_unit": 0.9,
        "temperature_impact": -0.0006,
        "max_impact": -0.06,
        "label": "Green Building Standards",
        "description": "Energy-efficient construction, insulation, smart HVAC"
    },

    "waste_management": {
        "cost_per_unit": 0.5,
        "temperature_impact": -0.0003,
        "max_impact": -0.03,
        "label": "Waste & Recycling Systems",
        "description": "Methane capture, recycling plants, landfill reduction"
    }
}
